...
import 'package:eyepetizer/viewmodel/home/search_viewmodel.dart';
import 'package:eyepetizer/widget/home/search_item_widget.dart';
...
class SearchPage extends StatelessWidget {
  ...
  /// 搜索界面的topbar
  _searchBar(SearchViewModel model, BuildContext context) {
    return Padding(
      ...
      child: ConstrainedBox(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            // 提示文本，位于输入框内部
            hintText: StringConfig.interest_video,
            // hintText的样式
