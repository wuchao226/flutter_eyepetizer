...
import 'package:eyepetizer/viewmodel/mine/watch_history_viewmodel.dart';
...
class WatchHistoryPage extends StatefulWidget {
  @override
  WatchHistoryPageState createState() => new WatchHistoryPageState();
}

class WatchHistoryPageState extends State<WatchHistoryPage> {
  @override
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: appBar(StringConfig.watch_history),
  ...
  Widget _slidable(WatchHistoryViewModel model, int index) {
    return Slidable(
      ...
      child: VideoItemWidget(
        ...
        callBack: () {
          // TODO:跳转到 '/detail'
          toName('/detail', model.itemList[index]);
        },
